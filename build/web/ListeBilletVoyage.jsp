<%-- 
    Document   : ListeBilletVoyage
    Created on : 31 janv. 2024, 02:19:03
          ...
          <i class="hamburger align-self-center"></i>
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3">Reste billet voyage</h1>
                                            ...
                                            <table class="table table-hover my-0">
                                                <thead>
                                                    <tr>
                                                            ...
                                                            <th class="d-none d-md-table-cell">Nombre disponible</th>
                                                ...
                                                <% for(int i=0; i<lsvg.size();i++){%>
                                                    <tr>
                                                        <td class="d-none d-xl-table-cell"><% out.print((lsvg.get(i)).getNom()); %></td>
                                                        <td class="d-none d-xl-table-cell"><% out.print((lsvg.get(i)).getNomBouquet()); %></td>
                                                        <td class="d-none d-xl-table-cell"><% out.print((lsvg.get(i)).getNombreBillet()); %></td>
                                                        <td class="d-none d-xl-table-cell"><% out.print((lsvg.get(i)).getDuree()); %> jrs</td>
                                                    </tr>
                                                <%}%>	
                                                </tbody>
                                            </table>
