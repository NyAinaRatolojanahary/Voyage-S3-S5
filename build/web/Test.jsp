<%-- 
    Document   : Test
    Created on : 31 janv. 2024, 04:12:19
    Author     : Ny Aina Ratolo
--%>

<%-- 
    Document   : index
    Created on : 30 janv. 2024, 14:59:10
    Author     : Ny Aina Ratolo
--%>

<%@ page import="models.Statistique"%>
<%@ page import="java.util.ArrayList"%>

<%
    Statistique stat = new Statistique();
    String jsonPie = (String)stat.getNombreVenteParGenre();
    
    ArrayList<Statistique> lsStat = stat.getNombreVenteParGenreEtBouquet();
%>
...
<body>
          ...
          <i class="hamburger align-self-center"></i>
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3">Statistique</h1>
                                                ...
                                                <div class="card">
                                                    <div class="m-sm-4">
                                                        <div class="card-header">
                                                            <h5 class="card-subtitle text-muted">Nombre de vente par genre de client</h5>
                                                        </div>
                                                        <div class="card-body">
					...
					<div class="row">
                                            <div class="col-12">
                                                <div class="card">
                                                    <div class="m-sm-4">
                                                        <div class="card-header">
                                                            <h5 class="card-subtitle text-muted">Nombre de vente par genre de client par bouquet</h5>
                                                        </div>
                                                        <div class="card-body">
                                                                <div class="chart chart-sm">
		...
		document.addEventListener("DOMContentLoaded", function() {
			...
			new Chart(document.getElementById("chartjs-pie"), {
				...
				data: {
					labels: ["Female", "Male"],
					datasets: [{
						 data: [data.nombreFemale, data.nombreMale],
						backgroundColor: [
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        new Chart(document.getElementById("chartjs-bar"), {
            type: "bar",
            data: {
                labels: [<% for (Statistique s : lsStat) { %> "<%= s.getNomBouquet() %>", <% } %>],
                datasets: [{
                    label: "Male",
                    ...
                    data: [<% for (Statistique s : lsStat) { %> <%= s.getNombreMale() %>, <% } %>],
                    barPercentage: .75,
                    ...
                    data: [<% for (Statistique s : lsStat) { %> <%= s.getNombreFemale() %>, <% } %>],
                    barPercentage: .75,
                    categoryPercentage: .5
                }]
            },
