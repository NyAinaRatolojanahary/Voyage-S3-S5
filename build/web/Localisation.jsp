...
<%  Localisation all = new Localisation();
    ArrayList<Localisation> tout = all.selectAll();
%>
<!DOCTYPE html>
<html lang="en">
          ...
          <i class="hamburger align-self-center"></i>
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3">Localisation</h1>
                                            ...
                                            <form>
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select mb-3">
                                                        ...
                                                        %>  
                                                        <option value="<% out.print(tout.get(i).getIdLocalisation()); %>"><% out.print(tout.get(i).getNomLocalisation()); %></option>
                                                        <%
                                                            }
                                                        %>
                                                     </select>
