<%-- 
    ...
    Created on : 16 janv. 2024, 15:43:46
...
<%    
    ...
    ArrayList<Voyage> lsvg = vg.getAllVoyage();
    
    Employee emp = new Employee();
    ArrayList<Employee> lsemp = emp.getAllEmployee();
%>
          ...
          <i class="hamburger align-self-center"></i>
			...
			<main class="content">
				<div class="container-fluid p-0">
					<h1 class="h3 mb-3">Reservation Voyage</h1>
					<div class="row">
						<div class="col-12">
							<div class="card">
								<div class="card-body">
                                                                    <div class="card-body">
                                                                        <div class="m-sm-4">
                                                                            <form action="./AjoutAffectationServlet" method="post">
                                                                                <div class="mb-3">
                                                                                    <label class="form-label">Voyage</label>

                                                                                    <select class="form-select mb-3" name="voyage">
                                                                                ...
                                                                                <div class="mb-3">
                                                                                    ...
                                                                                    <select class="form-select mb-3" name="emp">
                                                                                        <% for(int i=0; i<lsemp.size();i++){%>
                                                                                        <option value="<%out.print(lsemp.get(i).getIdEmployee());%>"><%out.print(lsemp.get(i).getNomEmployee());%></option>
                                                                                        <%}%>
                                                                                     </select>
                                                                                </div>
