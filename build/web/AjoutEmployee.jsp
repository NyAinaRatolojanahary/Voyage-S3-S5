<%-- 
    Document   : AjoutEmployee
    Created on : 16 janv. 2024, 14:47:07
...
<%    
    ...
    ArrayList<Employee> lstd = td.getAllTypeEmployee();
%>
          ...
          <i class="hamburger align-self-center"></i>
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3">Ajout Employee</h1>
					<div class="row">
						<div class="col-12">
							<div class="card">
								<div class="card-body">
                                    <div class="card-body">
                                        <div class="m-sm-4">
                                            <form action="./AjoutNouveauEmployee" method="post">
                                                <div class="mb-3">
                                                    <label class="form-label">Nom Employee</label>
                                                    <input class="form-control form-control-lg" type="text" name="nom" placeholder="Entrer ici le nom" />
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label">Date d'Embauche</label>
                                                    <input class="form-control form-control-lg" type="date" name="dateEmbauche" required/>
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label">Taux horaire</label>
                                                    <input class="form-control form-control-lg" type="text" name="th" placeholder="Entrer ici le montant" />
                                                </div>
                                                 <% if(errMess!= null){%>
					...
					<h1 class="h3 mb-3">Ajout Type Employee</h1>
					<div class="row">
						<div class="col-12">
							<div class="card">
								<div class="card-body">
                                    <div class="card-body">
                                        <div class="m-sm-4">
                                            <form action="./AjoutNouveauTypeEmployee" method="post">
                                                <div class="mb-3">
                                                    <label class="form-label">Nom Type Employee</label>
                                                    <input class="form-control form-control-lg" type="text" name="nom" placeholder="Entrer ici le nom" />
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label">TJM</label>
                                                    <input class="form-control form-control-lg" type="number" name="tjm" placeholder="Entrer ici le TJM" min="1"/>
                                                </div>
                                                 <% if(errMess!= null){%>
                                                    <div class="badge bg-danger"><%= errMess%></div>
                                                <%}%>
