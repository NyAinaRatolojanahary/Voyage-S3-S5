<%-- 
    Document   : AjoutBillet
    Created on : 11 janv. 2024, 15:20:03
          ...
          <i class="hamburger align-self-center"></i>
			...
			<main class="content">
				<div class="container-fluid p-0">
					<h1 class="h3 mb-3">Ajout billet d'activite dans le stock</h1>
					<div class="row">
						<div class="col-12">
							<div class="card">
								<div class="card-body">
                                                                    <div class="card-body">
                                                                        <div class="m-sm-4">
                                                                            <form action="./AjoutBilletServlet" method="post">
                                                                                <div class="mb-3">
