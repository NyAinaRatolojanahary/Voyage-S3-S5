...
<!--							<div class="dropdown-menu dropdown-menu-end">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3">Ajout d'activite</h1>
						...
						<div class="col-12">
							<div class="card">
								...
								<div class="card-body">
                                    <div class="card-body">
                                        <div class="m-sm-4">
                                            <form method="post" action="./AjoutActivite">
                                                <div class="mb-3">
                                                    <label class="form-label">Ajout d'activite</label>
                                                    <input class="form-control form-control-lg" type="text" name="nomactivite" placeholder="Entrer ici l'activite que vous avez choisie" />
                                                </div>
