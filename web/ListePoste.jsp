<%-- 
    Document   : ListePoste
    Created on : 23 janv. 2024, 14:55:48
...
<%  Employee emp = new Employee();
    ArrayList<Employee> act = emp.ListeEmployeePoste(); %>
          ...
          <i class="hamburger align-self-center"></i>
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3">Liste Employee avec poste</h1>
                                            ...
                                            <table class="table table-hover my-0">
                                                <thead>
                                                    <tr>
                                                            ...
                                                            <th class="d-none d-xl-table-cell">Taux horaire</th>
                                                            <!--<th class="d-none d-xl-table-cell">Anciennete</th>-->
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                <% for(int i=0; i<act.size();i++){%>
                                                    <tr>
                                                        <td class="d-none d-xl-table-cell"><% out.print((act.get(i)).getNomEmployee()); %></td>
                                                        <td class="d-none d-xl-table-cell"><% out.print((act.get(i)).getDateEmbauche()); %></td>
                                                        <td class="d-none d-xl-table-cell"><% out.print((act.get(i)).getNomTypeEmployee()); %></td>
                                                        <td class="d-none d-xl-table-cell"><% out.print((act.get(i)).getTjm()); %> Ar</td>
                                                        <!--<td class="d-none d-xl-table-cell"><% // out.print((act.get(i)).getAnciennete()); %> Ans</td>-->
                                                    </tr>
                                                <%}%>	
                                                </tbody>
                                            </table>
