<%-- 
    Document   : ListeStockBilletActivite
    Created on : 31 janv. 2024, 02:31:26
    Author     : Ny Aina Ratolo
--%>

<%@page import="java.util.ArrayList"%>
<%@page import="models.AchatBillet" %>
<%  AchatBillet ab = new AchatBillet();
    ArrayList<AchatBillet> lsab = ab.getBilletActiviteDispo(); 
%>
          ...
          <i class="hamburger align-self-center"></i>
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3">Reste billet activite en stock</h1>
                                        ...
                                        <div class="m-sm-4">
                                            <table class="table table-hover my-0">
                                                ...
                                                <% for(int i=0; i<lsab.size();i++){%>
                                                    <tr>
                                                        <td class="d-none d-xl-table-cell"><% out.print((lsab.get(i)).getNomActivite()); %></td>
                                                        <td class="d-none d-xl-table-cell"><% out.print((lsab.get(i)).getNombre()); %></td>
                                                    </tr>
                                                <%}%>	
                                                </tbody>
                                            </table>
