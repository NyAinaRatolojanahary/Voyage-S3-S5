                                        ...
                                        <div class="m-sm-4">
                                            <form action="./AjoutClientServlet" method="post">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control form-control-lg" type="text" name="prenom" placeholder="Entrer ici le prenom" />
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label">Date naissance</label>
                                                    <input class="form-control form-control-lg" type="date" name="dtn" required/>
                                                </div>
                                                <div class="mb-3">
