<%-- 
    Document   : AjoutVente
    Created on : 25 janv. 2024, 15:06:25
...
<%    
    ...
    ArrayList<Voyage> lsvg = vg.getAllVoyageDispo();
    
    Client ct = new Client();
    ArrayList<Client> lsct = ct.getAllClient();
          ...
          <i class="hamburger align-self-center"></i>
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3">Nouvelle vente</h1>
					<div class="row">
						<div class="col-12">
							<div class="card">
								<div class="card-body">
                                    <div class="card-body">
                                        <div class="m-sm-4">
                                            <form action="./AjoutVenteServlet" method="post">
												<div class="mb-3">
													<label class="form-label">Client</label>

													<select class="form-select mb-3" name="idClient">
														<% for(int i=0; i<lsct.size();i++){%>
														<option value="<%out.print(lsct.get(i).getIdClient());%>"><%out.print(lsct.get(i).getPrenomClient());%> <%out.print(lsct.get(i).getNomClient());%></option>
														<%}%>
													 </select>
												</div>
                                                <div class="mb-3">
													<label class="form-label">Voyage</label>
													<select class="form-select mb-3" name="idvoyage">
														<% for(int i=0; i<lsvg.size();i++){%>
														<option value="<%out.print(lsvg.get(i).getIdVoyage());%>"><%out.print(lsvg.get(i).getNom());%></option>
														<%}%>
													 </select>
												<div class="mb-3">
												...
												<div class="mb-3">
													<label class="form-label">Nombre de billet</label>
													<input class="form-control form-control-lg" type="number" name="nombre" min="1" placeholder="Entrer ici le nombre de billet" />
												</div>
                                                 <% if(errMess!= null){%>
