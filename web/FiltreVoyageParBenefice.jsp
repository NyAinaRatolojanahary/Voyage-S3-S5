<%-- 
    Document   : FiltreVoyageParBenefice
    Created on : 16 janv. 2024, 16:04:03
          ...
          <i class="hamburger align-self-center"></i>
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3">Filtre de voyage par benefice</h1>
					<div class="row">
						<div class="col-12">
							<div class="card">
								<div class="card-body">
                                    <div class="card-body">
                                        <div class="m-sm-4">
                                            <form action="./FiltreVoyageParBeneficeServlet" method="post">
                                                <div class="mb-3">
